...
namespace DL
{
    ...
    public partial class JFloresExamenLeenkenGroupEntities : DbContext
    {
        public JFloresExamenLeenkenGroupEntities()
            : base("name=JFloresExamenLeenkenGroupEntities")
        {
        }
        ...
        public virtual int EstadoAdd(string estado)
        {
            var estadoParameter = estado != null ?
                new ObjectParameter("Estado", estado) :
                new ObjectParameter("Estado", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("EstadoAdd", estadoParameter);
        }
